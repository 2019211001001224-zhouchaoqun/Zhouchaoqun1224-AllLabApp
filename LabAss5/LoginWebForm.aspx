...
<body>
    <form id="form1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SanpleDatabaseConnectionString1 %>" DeleteCommand="DELETE FROM [Logon] WHERE [UserNane] = @UserNane" InsertCommand="INSERT INTO [Logon] ([UserNane], [Password]) VALUES (@UserNane, @Password)" ProviderName="<%$ ConnectionStrings:SanpleDatabaseConnectionString1.ProviderName %>" SelectCommand="SELECT [UserNane], [Password] FROM [Logon]" UpdateCommand="UPDATE [Logon] SET [Password] = @Password WHERE [UserNane] = @UserNane">
            <DeleteParameters>
