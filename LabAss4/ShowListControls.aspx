...
<body>
    <form id="form1" runat="server">
        ...
        <div><h1>BulletedList</h1>
            <asp:BulletedList ID="BulletedList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="UserNane" DataValueField="UserNane" Height="32px" Width="191px">
            </asp:BulletedList>
        </div>
        ...
        <div><h1>RadioButtonList<asp:RadioButtonList ID="RadioButtonList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="UserNane" DataValueField="UserNane">
            </asp:RadioButtonList>
            </h1>
            <p>
